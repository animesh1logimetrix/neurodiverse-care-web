...
const THEMES: Record<string, CardTheme> = {
  ...
  blue: {
    cardBg: "bg-blue-50",
    badge: "bg-blue-100 text-[#2DA0FF] border border-blue-200",
    text: "text-[#2DA0FF]",
    dot: "bg-blue-400",
    addBtn: "bg-blue-400 hover:bg-[#2DA0FF] text-white",
  },
  purple: {
    cardBg: "bg-purple-50",
      ...
      <div className={`relative flex items-center justify-center py-2 px-3.5 ${theme.cardBg}`}>
        ...
        <div className="absolute right-2 top-1.5 flex items-center gap-1.5 shrink-0">
          <button
            ...
            className="p-1 rounded text-[#2DA0FF] hover:bg-white/60 transition-all cursor-pointer"
